ALTER TABLE public.workspace_document DROP COLUMN content_tsv;

ALTER TABLE public.ontology ALTER COLUMN name TYPE text;
ALTER TABLE public.ontology_concept ALTER COLUMN name TYPE text;
ALTER TABLE public.ontology_concept ALTER COLUMN code TYPE text;
ALTER TABLE public.workspace ALTER COLUMN name TYPE text;
ALTER TABLE public.workspace_document ALTER COLUMN name TYPE text;
ALTER TABLE public.workspace_config ALTER COLUMN name TYPE text;
ALTER TABLE public.workspace_guideline ALTER COLUMN name TYPE text;
ALTER TABLE public.workspace_annotation ALTER COLUMN entity TYPE text;
